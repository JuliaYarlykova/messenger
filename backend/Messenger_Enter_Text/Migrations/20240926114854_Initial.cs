        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HadBeen = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Config = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUser1", x => new { x.BlackListId, x.User1Id });
                    table.ForeignKey(
                        name: "FK_UserUser1_Users_BlackListId",
                        column: x => x.BlackListId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUser1_Users_User1Id",
                        column: x => x.User1Id,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FriendsPendingId = table.Column<int>(type: "int", nullable: false),
                    User2Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUser2", x => new { x.FriendsPendingId, x.User2Id });
                    table.ForeignKey(
                        name: "FK_UserUser2_Users_FriendsPendingId",
                        column: x => x.FriendsPendingId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUser2_Users_User2Id",
                        column: x => x.User2Id,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_Messages_MId",
                        column: x => x.MId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Complaints_Users_UId",
                        column: x => x.UId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Complaints_MId",
                table: "Complaints",
                column: "MId");

            migrationBuilder.CreateIndex(
                name: "IX_Complaints_UId",
                table: "Complaints",
                column: "UId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserUser1_User1Id",
                table: "UserUser1",
                column: "User1Id");

            migrationBuilder.CreateIndex(
                name: "IX_UserUser2_User2Id",
                table: "UserUser2",
                column: "User2Id");
        }
